...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="*epic-tech-context" workflow="D:/projects/hl7-capture/bmad/bmm/workflows/4-implementation/epic-tech-context/workflow.yaml">(Optional) Use the PRD and Architecture to create a Epic-Tech-Spec for a specific epic</item>
